...
base_path = f's3://child-comp-dp/{data_source}'
...
df.write\
    .format("delta") \
    .option("delta.enableChnageDataFeed","true") \
    .mode("append")\
...
# MAGIC %md
# MAGIC # Staging table just the arrive incremental data
...
# MAGIC %md
# MAGIC # TRANSFORMATIONS SAME AS WE HAVE DONE FOR BATCH PROCESSING
...
# 5. Drop duplicates
df_orders = df_orders.dropDuplicates(["order_id", "order_placement_date", "customer_id", "product_id"])
